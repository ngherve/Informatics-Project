<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Mechanical.aspx.cs" Inherits="alphadeliverable.Mechanical" %>
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="Mechanical.aspx">View Products</a>
                                    </li>
                                    <li class="breadcrumb-item active"> Mechanical Product Records
                                    </li>
                                </ol>
                            </div>
                        </div>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body"> 
                ...
                <section id="user-profile-cards" class="row mt-2">
                    <div class="col-12">
                        <h4 class="text-uppercase"> Mechanical Product Records</h4>
                    </div>
