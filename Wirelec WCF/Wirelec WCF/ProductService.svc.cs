...
namespace Wirelec_WCF
{
    ...
    public class ProductService : IProductService
    {
        ...
        public string AddProduct(Product product)
        {
            try
            {
                MySqlCommand cmd = new MySqlCommand("INSERT INTO PRODUCT( P_Name, P_Price, P_Image, P_Quantity, Supplier_Name, P_Type, W_ID) VALUES(@a1, @a2, @a3, @a4, @a5, @a6, @a7)", connection);
                ...
                cmd.Parameters.AddWithValue("@a7", product.W_ID);
        ...
        public string UpdateProduct(int id, string name, int price, string image, int quant, string sname, string type, int wid)
        {
            Product product = new Product();
            try
            {

                string mycommand = "UPDATE PRODUCT+ SET P_Name = '" + name + "',P_Price= '" + price + "', P_Image ='" + image + "',P_Quantity ='" + quant + "',Supplier_Name ='" + sname + "', P_Type='" + type + "',W_ID ='" + wid +  "'WHERE product.P_ID = '" + id + "'";
