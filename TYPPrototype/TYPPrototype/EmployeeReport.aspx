<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EmployeeReport.aspx.cs" Inherits="TYPPrototype.EmployeeReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function ()
        {
            ...
            $.ajax({
                url: "EmployeeReport.aspx/GetChartData",
                data: "",
                dataType: "json",
                type: "POST",
