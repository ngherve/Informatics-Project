                                ...
                                <div id="new-orders" class="media-list position-relative">
                                    <div class="table-responsive">
                                        <table id="new-orders-table" class="table table-hover table-xl mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="text-truncate">Cables</td>
                                                    ...
                                                    <td class="text-truncate">R8999.00</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-truncate">Ester Oils</td>
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                    ...
                                                    <td class="text-truncate">R5550.00</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-truncate">Barrier Tape</td>
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                    ...
                                                    <td class="text-truncate">R9000.00</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-truncate">Duct Tape</td>
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                    ...
                                                    <td class="text-truncate">R7500.00</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-truncate">Air-drying Varnishes</td>
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                    ...
                                                    <td class="text-truncate">R8500.00</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <table id="recent-orders" class="table table-hover table-xl mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-outline-warning round">Electrical</button>
                                                </td>
                                                <td>
                                                    <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                                                ...
                                                <td class="text-truncate">R 1200.00</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-truncate">R 1850.00</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-outline-success round">Industrial</button>
                                                </td>
                                                <td>
                                                    <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                                                ...
                                                <td class="text-truncate">R 3200.00</td>
                                            </tr>
                                            <tr>
                                                <td class="text-truncate"><i class="la la-dot-circle-o success font-medium-1 mr-1"></i> Paid</td>
                                                ...
                                                <td class="text-truncate">R 4500.00</td>
                                            </tr>
                                            <tr>
                                                <td class="text-truncate"><i class="la la-dot-circle-o success font-medium-1 mr-1"></i> Paid</td>
                                                ...
                                                <td class="text-truncate">R 1500.00</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
