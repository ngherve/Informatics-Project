<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="receivestock.aspx.cs" Inherits="TYPPrototype.receivestock" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                url: "receivestock.aspx/GetChartData",
                data: "",
                dataType: "json",
                type: "POST",
            ...
            <div class="content-header-light col-12">
                <div class="row">
                    <div class="content-header-left col-md-9 col-12 mb-2">                           
                        <h3 class="content-header-title">Recieved Stock Report</h3>
