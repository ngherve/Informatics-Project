<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MostSoldReport.aspx.cs" Inherits="TYPPrototype.MostSoldReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function ()
        {
            ...
            $.ajax({
                url: "MostSoldReport.aspx/GetChartData",
                data: "",
                dataType: "json",
                type: "POST",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="app-content content">
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Employee Task Report
                                    </li>
                                </ol>
                            </div>
                        </div>
        ...
        <h4 class="card-title" id="suggestiontask" runat="server"></h4>
    </div>
    <!-- END: Content-->
</asp:Content>
