...
{
    public partial class Warehouse2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Product[] Iproducts = prodService.GetAllProducts();
            foreach (Product prod in Iproducts)
            {
                if (prod.P_Type.Equals("Industrial"))
                {
